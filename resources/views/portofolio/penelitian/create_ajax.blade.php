<form id="formCreatePenelitian" method="POST" action="{{ route('portofolio.penelitian.store_ajax') }}" enctype="multipart/form-data">
    @csrf
        ...
        @if ($role === 'DOS')
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="file" class="form-control d-none" id="bukti" name="bukti" accept=".pdf,.jpg,.jpeg,.png" required
