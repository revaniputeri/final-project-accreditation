...
<body>
    ...
    <h3 class="text-center">DATA PORTOFOLIO DOSEN - PENGABDIAN MASYARAKAT</h3>
    ...
    <table class="border-all">
        ...
        <tbody>
            @foreach ($pengabdian as $key => $item)
                <tr>
                    <td class="text-center">{{ $key + 1 }}</td>
                    <td>{{ $item['id_pengabdian'] }}</td>
                    ...
                    <td>
                        @if ($item['bukti'])
                            <a href="{{ url('storage/portofolio/pengabdian/' . $item['bukti']) }}" target="_blank">Lihat File</a>
                        @else
                            Tidak ada file
                        @endif
                    </td>
