            ...
            <table class="table table-bordered table-striped mb-0">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($karyaBuku->bukti)
                                <a href="{{ asset('storage/portofolio/karya_buku/' . $karyaBuku->bukti) }}" target="_blank">Lihat Bukti</a>
                            @else
                                Tidak ada file
                            @endif
                        </td>
    ...
    <div class="card card-outline card-warning shadow-sm">
        ...
        <div class="card-body">
            <form id="form-validasi" method="POST"
                action="{{ route('portofolio.karya_buku.validasi_ajax', $karyaBuku->id_karya_buku) }}">
                @csrf
