...
<body>
    ...
    <h3 class="text-center">DATA PORTOFOLIO DOSEN - KARYA BUKU</h3>
    ...
    <table class="border-all">
        ...
        <tbody>
            @foreach ($karyaBuku as $key => $item)
                <tr>
                    <td class="text-center">{{ $key + 1 }}</td>
                    {{-- <td>{{ $item['id_karya_buku'] }}</td> --}}
                    ...
                    <td>
                        @if ($item['bukti'])
                            <a href="{{ url('storage/portofolio/karya_buku/' . $item['bukti']) }}" target="_blank">Lihat File</a>
                        @else
                            Tidak ada file
                        @endif
                    </td>
