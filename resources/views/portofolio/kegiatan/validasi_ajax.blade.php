            ...
            <table class="table table-bordered table-striped mb-0">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($kegiatan->bukti)
                                <a href="{{ asset('storage/portofolio/kegiatan/' . $kegiatan->bukti) }}" target="_blank">Lihat Bukti</a>
                            @else
                                Tidak ada file
                            @endif
                        </td>
    ...
    <div class="card card-outline card-warning shadow-sm">
        ...
        <div class="card-body">
            <form id="form-validasi" method="POST"
                action="{{ route('portofolio.kegiatan.validasi_update', $kegiatan->id_kegiatan) }}">
                @csrf
