...
<div class="modal-body">
            ...
            <table class="table table-bordered table-striped mb-0">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if ($hki->bukti)
                                <a href="{{ url('storage/portofolio/hki/' . $hki->bukti) }}" target="_blank">Lihat File</a>
                            @else
                                Tidak ada file
                            @endif
                        </td>
    ...
    <div class="card card-outline card-warning shadow-sm">
        ...
        <div class="card-body">
            <form id="form-validasi" method="POST" action="{{ route('portofolio.hki.validasi_update', $hki->id_hki) }}">
                @csrf
