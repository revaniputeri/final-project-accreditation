...
<div class="modal-body">
            ...
            <table class="table table-bordered table-striped mb-0">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($profesi->bukti)
                                <a href="{{ asset('storage/portofolio/profesi/' . $profesi->bukti) }}" target="_blank">Lihat Bukti</a>
                            @else
                                Tidak ada file
                            @endif
                        </td>
    ...
    <div class="card card-outline card-warning shadow-sm">
        ...
        <div class="card-body">
            <form id="form-validasi" method="POST" action="{{ route('portofolio.profesi.validasi_update', $profesi->id_profesi) }}">
                @csrf
