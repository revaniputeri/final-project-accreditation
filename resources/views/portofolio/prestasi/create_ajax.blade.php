<form id="formCreatePrestasi" method="POST" action="{{ route('portofolio.prestasi.store_ajax') }}"
    ...
    <div class="modal-body">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="prestasi_yang_dicapai" name="prestasi_yang_dicapai" required>
        ...
        <div class="mb-3">
            ...
            <input type="date" class="form-control" id="waktu_pencapaian" name="waktu_pencapaian" required>
