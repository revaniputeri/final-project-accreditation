                    ...
                    <tr>
                        ...
                        <td>
                            @if($sertifikasi->bukti)
                                <a href="{{ asset('storage/portofolio/sertifikasi/' . $sertifikasi->bukti) }}" target="_blank">Lihat Bukti</a>
                            @else
                                Tidak ada file
                            @endif
                        </td>
    ...
    <div class="card card-outline card-warning shadow-sm">
        ...
        <div class="card-body">
            <form id="form-validasi" method="POST"
                action="{{ route('portofolio.sertifikasi.validasi_update', $sertifikasi->id_sertifikasi) }}">
                @csrf
