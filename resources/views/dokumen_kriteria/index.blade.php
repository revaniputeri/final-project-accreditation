...
@section('content')
    <ul class="nav nav-tabs" id="kategoriTabs" role="tablist">
        @foreach ($kategoriList as $index => $kategori)
            <li class="nav-item" role="presentation">
                <button class="nav-link @if ($kategori === $selectedKategori) active @endif" id="tab-{{ $kategori }}"
                    data-toggle="tab" data-target="#content-{{ $kategori }}" type="button" role="tab"
                    aria-controls="content-{{ $kategori }}"
    ...
    <div class="tab-content" id="kategoriTabsContent">
        @foreach ($kategoriList as $kategori)
            ...
            @endphp
            <div class="tab-pane fade @if ($kategori === $selectedKategori) show active @endif" id="content-{{ $kategori }}"
                role="tabpanel" aria-labelledby="tab-{{ $kategori }}">
            ...
            $(document).on('submit', '#formCreateDokumenPendukung, #formEditDokumenPendukung', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        ...
                        var activeKategori = $('ul#kategoriTabs button.nav-link.active').attr('id').replace('tab-', '');
