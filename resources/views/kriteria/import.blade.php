...
<form id="form-import" action="{{ route('kriteria.import_ajax') }}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="modal-body">
        ...
        <div class="mb-3">
            ...
            <div>
                <a href="{{ asset('template/template_kriteria.xlsx') }}" class="btn btn-success btn-sm" download>
