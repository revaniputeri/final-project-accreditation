        ...
        <div class="card shadow-sm">
            <div class="card-header bg-primary border-bottom">
                <div class="d-flex justify-content-between align-items-center">
                    <h3 class="card-title mb-0 text-white">Daftar User</h3>
                    <div class="card-tools">
                        <a id="exportPdfBtn" class="btn btn-custom-blue me-2" href="{{ route('user.export_pdf') }}">
                            <i class="fa-solid fa-file-pdf me-2"></i> Export PDF
                        </a>
                        <a id="exportExcelBtn" class="btn btn-custom-blue me-2" href="{{ route('user.export_excel') }}">
                            <i class="fas fa-file-excel me-2"></i> Export Excel
                        </a>
                        <button class="btn btn-custom-blue me-2" onclick="modalAction('{{ route('user.import') }}')">
                            <i class="fa-solid fa-file-arrow-up me-2"></i> Import Data
                        </button>
                        <button onclick="modalAction('{{ route('user.create_ajax') }}')" class="btn btn-custom-blue">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            function updateExportPdfLink() {
                ...
                var url = new URL("{{ route('user.export_pdf') }}", window.location.origin);
                if (idLevel) {
            ...
            function updateExportExcelLink() {
                var idLevel = $('#id_level').val();
                var url = new URL("{{ route('user.export_excel') }}", window.location.origin);
                if (idLevel) {
                    url.searchParams.set('id_level', idLevel);
                }
