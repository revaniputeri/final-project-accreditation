...
<div class="modal-body">
            ...
            <table class="table table-bordered table-striped mb-0">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($penelitian->bukti)
                                <a href="{{ asset('storage/' . $penelitian->bukti) }}" target="_blank">Lihat Bukti</a>
                            @else
                                Tidak ada file
                            @endif
                        </td>
    ...
    <div class="card card-outline card-warning shadow-sm">
        ...
        <div class="card-body">
            <form id="form-validasi" method="POST" action="{{ route('p_penelitian.validasi_update', $penelitian->id_penelitian) }}">
                @csrf
