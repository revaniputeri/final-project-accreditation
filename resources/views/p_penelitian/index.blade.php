            ...
            <div class="card-header bg-primary border-bottom">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="card-tools">
                        <a id="exportPdfBtn" class="btn btn-custom-blue me-2" href="{{ route('p_penelitian.export_pdf') }}">
                            <i class="fa-solid fa-file-pdf me-2"></i> Export PDF
                        </a>
                        <a id="exportExcelBtn" class="btn btn-custom-blue me-2" href="{{ route('p_penelitian.export_excel') }}">
                            <i class="fas fa-file-excel me-2"></i> Export Excel
                        </a>
                        @if ($isAdm || $isDos)
                            <button class="btn btn-custom-blue me-2"
                                onclick="modalAction('{{ route('p_penelitian.import') }}')">
                                <i class="fa-solid fa-file-arrow-up me-2"></i> Import Data
                            </button>
                            <button onclick="modalAction('{{ route('p_penelitian.create_ajax') }}')"
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            function updateExportLinks() {
                ...
                var pdfUrl = new URL("{{ route('p_penelitian.export_pdf') }}");
                ...
                var excelUrl = new URL("{{ route('p_penelitian.export_excel') }}");
